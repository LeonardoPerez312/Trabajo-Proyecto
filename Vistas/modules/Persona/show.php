                ...
                <?php if(!empty($_GET["id"]) && isset($_GET["id"])){
                    ...
                    if(!empty($DataUsuario)){
                        ...
                        <div class="card-header">
                            <h3 class="card-title"><?= $DataUsuario->getIdPersona()  ?></h3>
                        </div>
                        <div class="card-body">
                            <p>
                            ...
                            <p class="text-muted">
                                <?= $DataUsuario->getNombre()." ".$DataUsuario->getApellidos() ?>
                            </p>
                            <hr>
                            <strong><i class="fas fa-user mr-1"></i> Documento</strong>
                            <p class="text-muted"><?= $DataUsuario->getNombreDocumento().": ".$DataUsuario->getNumeroDocumento() ?></p>
                            <hr>
                            <strong><i class="fas fa-map-marker-alt mr-1"></i> Direccion</strong>
                            <p class="text-muted"><?= $DataUsuario->getCelular() ?></p>
                            <hr>
